...
file_path = 'data/focus/ascend_calibrate.csv'
...
plt.plot(x_data, linear_func(x_data, params[0], params[1]), label='Аппроксимация', color='red')
